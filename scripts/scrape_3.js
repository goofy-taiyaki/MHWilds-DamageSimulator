...
const targets = [
    {
        name: 'リオレウス',
        url: 'https://mhwilds.kiranico.com/ja/data/monsters/rioreusu',
        stateRemap: {}
    },
    {
        name: 'ジンダハド',
        url: 'https://mhwilds.kiranico.com/ja/data/monsters/zindahado',
        stateRemap: {}
    },
    {
        name: 'レダウ',
        url: 'https://mhwilds.kiranico.com/ja/data/monsters/redau',
        stateRemap: {
            'State_1': '帯電状態'
        }
    }
