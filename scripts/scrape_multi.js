...
const targets = [
    {
        name: 'セルレギオス',
        url: 'https://mhwilds.kiranico.com/ja/data/monsters/seruregiosu',
        stateRemap: {}
    },
    {
        name: 'タマミツネ',
        url: 'https://mhwilds.kiranico.com/ja/data/monsters/tamamitsune',
        stateRemap: {
            'State_1': '怒り状態'
        }
    }
    ...
    return new Promise((resolve) => {
        https.get(target.url, (res) => {
            ...
            res.on('end', () => {
                ...
                // Using a regular expression to find and replace the block for the given monster
                // Warning: relies on the monster currently existing in monsters.js
